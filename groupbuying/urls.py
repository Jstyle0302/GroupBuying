...
urlpatterns = [
    ...
    path('filtering_chatbot', views.filtering_chatbot, name='filtering_chatbot'),
    ...
    path('update_category_name', views.update_category_name,
    ...
    path('show_order/<str:order_id>-<str:from_profile>',
         views.show_order_page, name='show_order'),
    ...
    path('add_to_favorite-<str:shop_id>',
         views.add_to_favorite, name='add_to_favorite'),
    path('remove_from_favorite-<str:shop_id>',
         views.remove_from_favorite, name='remove_from_favorite'),
